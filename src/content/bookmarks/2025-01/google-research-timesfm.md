---
title: "Google Research发布TimesFM: 高性能时间序列预测基础模型"
slug: google-research-timesfm
description: |
  TimesFM（时间序列基础模型）是由Google Research开发的预训练模型，专注于时间序列预测。此模型支持单变量时间序列的预测，提供500m和200m的检查点，具有出色的性能表现。更新的TimesFM 2.0版本还支持微调和外部协变量。
tags: 
  - AI
  - dev
  - tool
  - python
  - opensource
pubDatetime: 2025-01-12T22:15:41+08:00
ogImage: https://opengraph.githubassets.com/d7e75e6d2ca9e49402ea5adc90320900a06ca1e80ce06ca76264d7099a32e0ee/google-research/timesfm
---
...
This repo contains the code to load public TimesFM checkpoints and run model inference. Please visit our [Hugging Face release](https://huggingface.co/collections/google/timesfm-release-66e4be5fdb56e960c1e482a6) to download model checkpoints.
...
[](#checkpoint-timesfm-10-200m--pytorch)
...
[](#checkpoint-timesfm-20-500m--jax-pytorch)
...
1. Running the provided benchmarks would require additional dependencies. Please see the `experiments` section fro more instructions.
