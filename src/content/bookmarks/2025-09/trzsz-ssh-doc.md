---
title: "Trzsz-ssh (tssh) 中文文档：高效文件传输工具"
slug: trzsz-ssh-doc
description: |
  trzsz（tssh）是一个兼容tmux的高效文件传输工具，支持进度条和目录传输。它是一个完全兼容OpenSSH的ssh客户端替代品，具有服务器批量登录、自动交互、密码记忆等强大功能。适用于多种操作系统，安装简单，欢迎深入了解！
tags: 
  - tool
  - opensource
pubDatetime: 2025-09-05T13:58:03+08:00
ogImage: 
---

[原文链接](https://trzsz.github.io/cn/ssh)

---

[![MIT License](https://img.shields.io/badge/license-MIT-green.svg?style=flat)](https://choosealicense.com/licenses/mit/) [![GitHub Release](https://img.shields.io/github/v/release/trzsz/trzsz-ssh)](https://github.com/trzsz/trzsz-ssh/releases) [![GitHub trzsz-ssh](https://img.shields.io/badge/GitHub-https%3A%2F%2Fgithub.com%2Ftrzsz%2Ftrzsz--ssh-blue?style=flat)](https://github.com/trzsz/trzsz-ssh)
...
* 在 `~/.tssh.conf` 中配置 `PromptThemeLayout = tiny` 选用 `tiny 小巧风`。 ![tssh tiny](https://trzsz.github.io/images/tssh_tiny.gif)
...
* 在 `~/.tssh.conf` 中配置 `PromptThemeLayout = simple` 选用 `simple 简约风`。 ![tssh simple](https://trzsz.github.io/images/tssh_simple.gif)

* `simple 简约风` 支持的颜色配置项、默认值和颜色枚举，和 `tiny 小巧风` 完全相同，请参考前文。

### table 表格风

* 在 `~/.tssh.conf` 中配置 `PromptThemeLayout = table` 选用 `table 表格风`。 ![tssh table](https://trzsz.github.io/images/tssh_table.gif)
